...
This repository documents my journey of learning **JavaScript** by building small, practical projects.

> The focus is not perfection, but **consistent progress and hands-on learning**.
...
- Develop **state → UI thinking**
- Prepare for React and modern frontend frameworks
...
- DOM updates & UI synchronization
- State management (Vanilla JS)
- Component-like thinking (pre-React)
